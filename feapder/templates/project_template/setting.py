...
# WARNING_LEVEL = "DEBUG"  # 报警级别阈值，DEBUG / INFO / WARNING / ERROR；优先级 >= 该阈值的告警才会发送
# WARNING_FAILED_COUNT = 1000  # 失败请求数 超过WARNING_FAILED_COUNT则报警
# WARNING_SUCCESS_RATE = 0.5  # 请求成功率低于WARNING_SUCCESS_RATE则报警
#
# # 打点监控 InfluxDB 2.x（默认关闭，需显式设置 INFLUXDB_ENABLE=True 启用）
# INFLUXDB_ENABLE = False  # 设为 True 才会初始化打点客户端
# INFLUXDB_URL = "http://localhost:8086"
# INFLUXDB_TOKEN = ""  # InfluxDB 2.x token
# INFLUXDB_ORG = ""    # InfluxDB 2.x 组织名
# INFLUXDB_BUCKET = "feapder"  # 写入的 bucket，需提前在 InfluxDB 中创建
# METRICS_DEFAULT_TAGS = {}  # 公共 tag，会附加到每一个数据点上
